export default {
  ...
  login: {
    title: 'Chào mừng bạn đến trang quản trị',
    logIn: 'Đăng nhập',
    username: 'Username',
    email: 'Email',
    password: 'Mật khẩu',
  ...
  table: {
    ...
    confirm: 'Xác nhận',
    topic_name_vi: 'Topic',
    topic_name_en: 'Topic (en)',
    name_vi: 'Tên level',
    name_en: 'Tên level (en)',
    description_en: 'Mô tả (en)',
    description_vi: 'Mô tả',
    upload: 'Upload ảnh',
    word_name_vi: 'Từ',
    word_name_en: 'Từ (en)',
    related_words_vi: 'Tự liên quan',
    related_words_en: 'Tự liên quan (en)',
    antonym_vi: 'Từ trái nghĩa',
    antonym_en: 'Từ trái nghĩa (en)',
    function_vi: 'Chức năng',
    function_en: 'Chức năng (en)',
    material_vi: 'Vật chất',
    material_en: 'Vật chất (en)',
    topic_id: 'Topic',
    upload_audio_vi: 'Upload audio',
    upload_audio_en: 'Upload audio (en)',
    level_id: 'Level',
    first_name: 'Họ',
    sur_and_last_name: 'Tên',
    phone_number: 'Số đt',
    email: 'Email',
    is_suspend: 'Khóa tài khoản',
    expire_time: 'Thời gian hết hạn',
    photo: 'Ảnh',
    student_name: 'Tên học sinh',
    student: 'Học sinh',
    game_name_vi: 'Tên trò chơi',
    game_name_en: 'Tên trò chơi (en)',
